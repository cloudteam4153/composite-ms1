...
# Helpers to convert mySQL id to UUID
class MySQLUUID(TypeDecorator):
    """
    Stores UUID as CHAR(32) in MySQL, returns `uuid.UUID` in Python.
    """
    impl = CHAR(32)
    cache_ok = True  # required by SQLAlchemy 2.x
    ...
    def process_bind_param(self, value, dialect):
        ...
        if isinstance(value, UUID):
            return value.hex  # 32-char, no dashes
        # accept strings / other types that can be cast to UUID
    ...
    def process_result_value(self, value, dialect):
        ...
        if value is None:
            return None
        # value will be like '31d24422d5044544ad27deccaa3f6293'
        return UUID(value)
